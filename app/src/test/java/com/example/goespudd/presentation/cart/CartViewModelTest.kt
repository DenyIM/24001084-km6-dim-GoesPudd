...
class CartViewModelTest {
    ...
    fun getAllCart() {
        every {
            cartRepository.getUserCartData()
        } returns
            flow {
                emit(
    ...
    fun decreaseCart() {
        every {
            cartRepository.decreaseCart(any())
        } returns
            flow {
    ...
    fun increaseCart() {
        every {
            cartRepository.increaseCart(any())
        } returns
            flow {
                emit(ResultWrapper.Success(true))
            }
    ...
    fun setCartNotes() {
        every {
            cartRepository.setCartNotes(any())
        } returns
            flow {
                emit(ResultWrapper.Success(true))
            }
